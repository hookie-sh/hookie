...
type SubscribeRequest struct {
	...
	// Optional: specific topic ID to subscribe to. If empty, subscribes to all topics for the application
	TopicId string `protobuf:"bytes,2,opt,name=topic_id,json=topicId,proto3" json:"topic_id,omitempty"`
	// Optional: organization ID context (for filtering/verification)
...
const file_proto_relay_proto_rawDesc = "" +
	...
	"\x06topics\x18\x01 \x03(\v2\f.relay.TopicR\x06topics\"\x8b\x01\n" +
	"\x05Topic\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x1d\n" +
	...
	"created_at\x18\x04 \x01(\x03R\tcreatedAt\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x05 \x01(\x03R\tupdatedAt2\xdc\x01\n" +
	"\fRelayService\x124\n" +
