...
hookie apps listen <app-id> --forward <endpoint-url>

# Forward events from a specific topic
hookie topics listen <topic-id> --forward <endpoint-url>
```
...
hookie apps listen app_123 --forward http://localhost:3001/webhooks

# Or use the shorthand
hookie apps listen app_123 -f http://localhost:3001/webhooks

# Forward events from a specific topic
hookie topics listen topic_456 --forward http://localhost:3001/webhooks
```
